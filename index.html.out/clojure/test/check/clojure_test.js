...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__18488){
...
var m = map__18489__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18489__$1,cljs.core.cst$kw$result);
...
try{var value__18227__auto__ = result;
if(cljs.core.truth_(value__18227__auto__)){
cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$pass,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,value__18227__auto__,cljs.core.cst$kw$message,null], null));
} else {
cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$fail,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,value__18227__auto__,cljs.core.cst$kw$message,null], null));
}

return value__18227__auto__;
}catch (e18491){var t__18269__auto__ = e18491;
return cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$error,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,t__18269__auto__,cljs.core.cst$kw$message,null], null));
}}
});
...
var begin_test_var_method_18493 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$cljs$test_SLASH_default,cljs.core.cst$kw$begin_DASH_test_DASH_var], null));
cljs.test.report.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$cljs$test_SLASH_default,cljs.core.cst$kw$begin_DASH_test], null),((function (begin_test_var_method_18493){
return (function (m){
cljs.core.reset_BANG_(clojure.test.check.clojure_test.last_trial_report,clojure.test.check.impl.get_current_time_millis());

if(cljs.core.truth_(begin_test_var_method_18493)){
return (begin_test_var_method_18493.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_18493.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_18493.call(null,m));
} else {
return null;
}
});})(begin_test_var_method_18493))
);
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__18494){
...
var report_map = map__18495__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18495__$1,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_property);
var or__8274__auto__ = cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(property_fun));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__18497){
var map__18498 = p__18497;
var map__18498__$1 = ((((!((map__18498 == null)))?((((map__18498.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18498.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__18498):map__18498);
var vec__18499 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18498__$1,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_trial);
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18499,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18499,(1),null);
if((so_far > (0))){
...
var temp__5535__auto__ = (function (){var and__8262__auto__ = clojure.test.check.clojure_test._STAR_report_trials_STAR_;
...
var G__18504 = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_shrinking,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_property,property_fun,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_params,cljs.core.vec(failing_params)], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__18504) : cljs.test.report.call(null,G__18504));
});
