...
var x__9007__auto__ = (((rng == null))?null:rng);
var m__9008__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__9007__auto__)]);
if(!((m__9008__auto__ == null))){
return (m__9008__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9008__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9008__auto__.call(null,rng));
} else {
var m__9008__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__9008__auto____$1 == null))){
return (m__9008__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9008__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9008__auto____$1.call(null,rng));
} else {
...
var x__9007__auto__ = (((rng == null))?null:rng);
var m__9008__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__9007__auto__)]);
if(!((m__9008__auto__ == null))){
return (m__9008__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9008__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9008__auto__.call(null,rng));
} else {
var m__9008__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__9008__auto____$1 == null))){
return (m__9008__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9008__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9008__auto____$1.call(null,rng));
} else {
...
var x__9007__auto__ = (((rng == null))?null:rng);
var m__9008__auto__ = (clojure.test.check.random.split[goog.typeOf(x__9007__auto__)]);
if(!((m__9008__auto__ == null))){
return (m__9008__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9008__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9008__auto__.call(null,rng));
} else {
var m__9008__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__9008__auto____$1 == null))){
return (m__9008__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9008__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9008__auto____$1.call(null,rng));
} else {
...
var x__9007__auto__ = (((rng == null))?null:rng);
var m__9008__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__9007__auto__)]);
if(!((m__9008__auto__ == null))){
return (m__9008__auto__.cljs$core$IFn$_invoke$arity$2 ? m__9008__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9008__auto__.call(null,rng,n));
} else {
var m__9008__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__9008__auto____$1 == null))){
return (m__9008__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__9008__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9008__auto____$1.call(null,rng,n));
} else {
...
var G__16622 = z;
if(((24) > (function (){var G__16623 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__16623) : clojure.test.check.random.longs.bit_count.call(null,G__16623));
})())){
return clojure.test.check.random.longs.bit_xor(G__16622,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__16622;
}
});
...
var G__16626 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__16627 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__16626;
ret = G__16627;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__8945__auto__,writer__8946__auto__,opt__8947__auto__){
return cljs.core._write(writer__8946__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__8274__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16629__$1,cljs.core.cst$kw$state);
var vec__16631 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16631,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16631,(1),null);
