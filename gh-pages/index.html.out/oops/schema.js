...
var G__20247 = cljs.core.first(element_str);
switch (G__20247) {
case "?":
arr.push((1));
...
var G__20249 = cljs.core.next(items);
items = G__20249;
continue;
} else {
return null;
...
var G__20250 = cljs.core.next(items);
items = G__20250;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__20252 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__20252) : is_valid_QMARK_.call(null,G__20252));
})())){
var G__20253 = cljs.core.next(cljs.core.next(items));
items = G__20253;
continue;
} else {
return true;
...
switch (G__20256) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__20256){
return (function (p1__20254_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20254_SHARP_,(2));
});})(G__20256))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20255_SHARP_,(1));
});})(G__20256))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20256)].join('')));
