...
var and__8262__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__8262__auto__)){
var and__8262__auto____$1 = cljs.core.not(oops.helpers.is_prototype_QMARK_(f));
...
var and__8262__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__8262__auto__)){
...
var G__14586 = cljs.core.next(items);
items = G__14586;
continue;
} else {
return arr;
...
var x14587 = error;
x14587.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL;

x14587.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = ((function (x14587){
